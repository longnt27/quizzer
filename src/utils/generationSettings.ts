...
export const getGenerationConcurrency = () => readClampedInteger(concurrencyKey, 1, 1, 10);
export const getGenerationBatchSize = () => readClampedInteger(batchSizeKey, 10, 5, 25);
...
export const setGenerationConcurrency = (value: number) => {
  ...
  window.dispatchEvent(new Event('quizzer:generation-settings'));
};
