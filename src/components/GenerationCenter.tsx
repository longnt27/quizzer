...
import { Alert, Badge, Button, Empty, Input, List, Modal, Progress, Select, Space, Tag, Typography } from 'antd';
...
import { cancelGenerationJob, removeGenerationJob, resumeGenerationJob, retryGenerationJob } from '../utils/generationQueue';
