...
const setupRollbackEnv = async (format = 'zip') => {
  ...
  const unsigned = {
    ...
    artifacts: [{
      ...
      architecture: 'arm64',
      format,
      url: `https://github.com/longnt27/quizzer/releases/download/v1.2.0/quizzer-1.2.0-macos-arm64.${format}`,
      size: content.length,
      sha256,
      minimumOs: 'macOS 13',
    }],
...
test('apply uses the exact signed artifact selected during download', async () => {
  ...
  try {
    ...
    const dmgArtifact = {
      ...
      architecture: 'arm64',
      format: 'dmg',
      url: 'https://github.com/longnt27/quizzer/releases/download/v1.2.0/quizzer-1.2.0-macos-arm64.dmg',
    ...
    return {
      ...
      manifest: signReleaseManifest({
        ...
        artifacts: [{
          ...
          architecture: 'arm64',
          format: 'pkg',
          url: `https://github.com/longnt27/quizzer/releases/download/v${version}/${artifactName}`,
          size: content.length,
